  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden cursor-pointer group hover:-translate-y-0.5 hover:border-gray-200 transition-all duration-150">
      ...
      <div className="px-2.5 pt-2 pb-1.5">
        ...
        {/* Titre */}
        <h2 className="text-[12px] font-bold text-gray-950 leading-snug line-clamp-2 min-h-[32px] mb-1.5">
          {item.title}
        </h2>

        {/* Ville + adresse */}
        <p className="text-[10px] font-bold text-gray-500 flex items-center gap-1 mb-0.5 truncate">
          <svg className="w-2.5 h-2.5 flex-shrink-0 text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      >
        {item.type === "AUCTION" && auction ? (
          <>
            ...
            <span
              className={`font-semibold ml-auto flex items-center gap-0.5 ${auction.endDate &&
